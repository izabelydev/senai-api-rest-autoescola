package br.com.senai.autoescola_n321.exception.types.handler;
...
import br.com.senai.autoescola_n321.exception.types.dto.DadosBadRequest;
...
public class GlobalHandleException {
    ...
    public ResponseEntity handleUsuarioNaoExisteException(UsuarioNaoExisteException e) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(e.getMessage());
    }
