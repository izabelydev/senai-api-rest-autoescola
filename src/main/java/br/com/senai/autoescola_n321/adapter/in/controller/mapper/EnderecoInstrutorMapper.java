...
@Component
public class EnderecoInstrutorMapper {
    public EnderecoInstrutor toEntity(DadosEndereco dados) {
        return new EnderecoInstrutor(
                dados.logradouro(),
                dados.bairro(),
                dados.uf(),
                dados.cidade(),
    ...
    public DadosEndereco toDto(EnderecoInstrutor dados) {
    ...
    public void atualizarVoToEntity(DadosEndereco dados, EnderecoInstrutor endereco) {
